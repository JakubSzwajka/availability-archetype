...
def main() -> None:
    ...
    weekday_slot = SlotSet({TimeSlot(Time(9, 0), Time(17, 0))})
    ...
    print("10-11:", resource.is_available(DateSlot(monday, Time(10, 0), Time(11, 0))))
    print("17-18:", resource.is_available(DateSlot(monday, Time(17, 0), Time(18, 0))))
    ...
    resource.set_overwrite_availability(
        tuesday,
        SlotSet({TimeSlot(Time(9, 0), Time(12, 0))}),
    )

    banner("Tuesday overwrite (9-12 only)")
    print("10-11:", resource.is_available(DateSlot(tuesday, Time(10, 0), Time(11, 0))))
    print("14-15:", resource.is_available(DateSlot(tuesday, Time(14, 0), Time(15, 0))))

    # 4. Add a booking lock on Monday 13-14 (buffer makes it 12:45-14:15)
    resource.lock(DateSlot(monday, Time(13, 0), Time(14, 0)))

    banner("Lock Monday 13-14 with 15-min buffer")
    print("12:30-12:44:", resource.is_available(DateSlot(monday, Time(12, 30), Time(12, 44))))
    print("12:45-13:00:", resource.is_available(DateSlot(monday, Time(12, 45), Time(13, 0))))
    print("14:00-14:14:", resource.is_available(DateSlot(monday, Time(14, 0), Time(14, 14))))
    print("14:15-14:30:", resource.is_available(DateSlot(monday, Time(14, 15), Time(14, 30))))

    # 5. Mark a full day off by locking 00:00-23:59
    day_off = date(2025, 7, 3)
    resource.lock(DateSlot(day_off, Time(0, 0), Time(23, 59)))

    banner(f"Whole day off {day_off}")
    print("09-10:", resource.is_available(DateSlot(day_off, Time(9, 0), Time(10, 0))))
