...
class TestResourceLockAvailability:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TimeSlotSet({TimeSlot(Time(13, 0), Time(14, 0))}), Time(13, 30), Time(13, 45), False),
            # slot adjacent to lock end -> available
            (TimeSlotSet({TimeSlot(Time(13, 0), Time(14, 0))}), Time(14, 0), Time(15, 0), True),
            # lock whole day -> unavailable
            (TimeSlotSet({TimeSlot(Time(9, 0), Time(17, 0))}), Time(10, 0), Time(11, 0), False),
            # lock outside availability window -> no effect
            (TimeSlotSet({TimeSlot(Time(17, 0), Time(18, 0))}), Time(10, 0), Time(11, 0), True),
        ],
    )
