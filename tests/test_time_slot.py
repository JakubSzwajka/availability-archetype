...
class TestTimeSlot:
    ...
    def test_Time_slot_overlaps(self, slot1: TimeSlot, slot2: TimeSlot, expected: bool):
    ...
    def test_Time_slot_includes(self, slot1: TimeSlot, slot2: TimeSlot, expected: bool):
    ...
    def test_Time_slot_merge_success(
        self, slot1: TimeSlot, slot2: TimeSlot, expected: TimeSlot
    ):
    ...
    def test_Time_slot_merge_failure(self, slot1: TimeSlot, slot2: TimeSlot):
    ...
    def test_Time_slot_subtract_success(
        self, slot1: TimeSlot, slot2: TimeSlot, expected: set[TimeSlot]
    ):
    ...
    def test_Time_slot_subtract_failure(self, slot1: TimeSlot, slot2: TimeSlot):
        with pytest.raises(ValueError):
